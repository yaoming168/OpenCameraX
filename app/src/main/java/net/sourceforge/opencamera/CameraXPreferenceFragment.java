...
/*
用来显示设置的Fragment UI。
注意，最初这是一个PreferenceActivity而不是一个PreferenceFragment，它要求所有的通信都通过bundle进行(因为这替换了MainActivity，
这意味着我们无法访问该类中的数据。
这不再适用，因为现在使用了一个PreferenceFragment，但我仍然保持通过bundle传递信息(至少大部分)。
还要注意的是，通过一个bundle传递可能是必要的，以避免访问预览，它可以是空的-请参阅下面关于视频分辨率的注意。
参见https://stackoverflow.com/questions/14093438/after-the-rotate-oncreate-fragment-is-called-before-oncreate-fragmentactivi。
 */
public class CameraXPreferenceFragment extends PreferenceFragment implements OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
            ...
            pref.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    if( newValue.equals("preference_raw_yes") || newValue.equals("preference_raw_only") ) {
                        ...
                        if( !done_raw_info ) {
                            AlertDialog.Builder alertDialog = new AlertDialog.Builder(CameraXPreferenceFragment.this.getActivity());
		...
		/* Set up video resolutions.
		   ...
		   if the application is being recreated, CameraXPreferenceFragment.onCreate() is called via
                    ...
                    public boolean onPreferenceChange(Preference arg0, Object newValue) {
                        if( pref.getKey().equals("preference_camera_api") ) {
                            ...
                            if( list_pref.getValue().equals(newValue) ) {
                                ...
                                CameraXActivity main_activity = (CameraXActivity) CameraXPreferenceFragment.this.getActivity();
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    if( pref.getKey().equals("preference_use_camera2") ) {
                        ...
                        MainActivity main_activity = (MainActivity)CameraXPreferenceFragment.this.getActivity();
                        main_activity.restartOpenCamera();
                        return false;
                    }
                    return false;
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    if( pref.getKey().equals("preference_about") ) {
                        ...
                        int version_code = -1;
                        try {
                            PackageInfo pInfo = CameraXPreferenceFragment.this.getActivity().getPackageManager().getPackageInfo(CameraXPreferenceFragment.this.getActivity().getPackageName(), 0);
                        ...
                        about_string.append("\nPackage: ");
                        about_string.append(CameraXPreferenceFragment.this.getActivity().getPackageName());
                        about_string.append("\nAndroid API version: ");
                        ...
                        }
                        {
                            ...
                            Display display = CameraXPreferenceFragment.this.getActivity().getWindowManager().getDefaultDisplay();
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    if( pref.getKey().equals("preference_save_settings") ) {
                        ...
                        final CameraXActivity main_activity = (CameraXActivity) CameraXPreferenceFragment.this.getActivity();
                        try {
